<?php require_once('header.php'); ?>
	...
	@session_start();
		$registros=mysql_query("select * from usuario where nickname='$_SESSION[usuarioactual]'",$con);
		...
		echo('
			...
			$registro2=mysql_query("select * from tutorial INNER JOIN usuario ON(tutorial.autor=usuario.nickname) where nickname='$_SESSION[usuarioactual]'",$con);
