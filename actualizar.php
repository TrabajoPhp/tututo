		...
		<div id="main">
				...
				<?php
							...
							<li>
								...
								<input type="text"  name="nombre" id="nombre" placeholder="Nombre y Apellido" value="'.$resultado->nombre.'" required />
							</li>
							<li>
								<label for="email">Email:</label>
								<input type="email" name="email" id="email" placeholder="nombre@ejemplo.com.ar" value="'.$resultado->nombre.'" required />
							</li>
							<li>
